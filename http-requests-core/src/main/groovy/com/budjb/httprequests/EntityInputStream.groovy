...
/**
 * An {@link InputStream} wrapper that tracks whether the stream has been closed. Once closed, it throws
 * an {@link IOException} if any further reads are attempted.
 */
